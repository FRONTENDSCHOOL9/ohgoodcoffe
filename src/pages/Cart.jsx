        ...
        <div className="contents-cart">
          <div className="l_wrapper">
            <div className="cart">
                ...
                <div className="cart-layout cart-procuct">
                  <div className="cart-item-info">
                    <div className="cart-item-cover">
                      <img src="/ohgoodcoffee/assets/coffee-1.jpg" alt="커피이미지" />
                    </div>
                    <p className="cart-item-title">
                      [프릳츠] Las Moritas Yellow Caturra Washed
                    </p>
                  </div>
                  {/* <!-- cart-item-info --> */}
                </div>
              ...
              <button className="button button-large btn-null btn-layout">
                주문하기
              </button>

              <a className="cart-more" href="#">계속 쇼핑하기</a>
            </div>
          </div>
          {/* <!-- l_wrapper --> */}
        </div>
